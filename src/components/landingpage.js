...
const styles = {
  page: { display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh", background: "#f9f6f1", fontFamily: "sans-serif" },
...
export default function AuthPage() {
  ...
  const onSubmit = (e) => {
    ...
    // mark user as authed and go to dashboard
