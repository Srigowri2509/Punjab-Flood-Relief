...
/**
 * NGO Relief Dashboard — Full Page (No Tailwind)
...
const S = {
  ...
  bandWrap: { padding: "16px 24px" },
  band: { background: PALETTE.band, borderRadius: 18, padding: 16 },
  ...
  controlsWrap: { padding: "12px 24px 0 24px" },
  controlsCard: {
    background: PALETTE.card,
    border: `1px solid ${PALETTE.border}`,
    borderRadius: 16,
        ...
        <div style={S.controlsCard}>
          <div style={S.controlsGrid}>
            <div>
              ...
              <input style={S.input} value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search…" />
            </div>
            <div>
              <label style={S.label}>Tehsil</label>
            ...
            <table style={S.table}>
              ...
              <tbody>
                {sorted.length ? (
                    ...
                    <tr key={r.id}>
                      ...
                      <td style={S.td}>
                        <div>
                          ...
                          {r.phone ? (
                            <a href={`tel:${r.phone}`} style={{ color: PALETTE.blue, textDecoration: "underline" }}>
                              {r.phone}
                            </a>
                          ) : (
                      ...
                      <td style={S.td}>
                        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                          ...
                          <button type="button" style={S.linkBtn} onClick={() => navigate(`/ngo/help/${r.id}`)}>
                            Help
                          </button>
                        </div>
                      </td>
                  ...
                  <tr>
                    <td style={{ ...S.td, textAlign: "center", color: PALETTE.textSub }} colSpan={8}>
